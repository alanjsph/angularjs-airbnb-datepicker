...
(function(factory) {
    ...
    $.fn.dateRangePicker = function(opt) {
        ...
        $(this).data('dateRangePicker', {
            ...
            clickADay: function(day){ // alanjsph@live.com
              opt.isFiredFromClickADayFn = 1;
              dayClicked(day);
            },
        ...
        function init_datepicker() {
            ...
            $(document).bind('click.datepicker', function(evt) {
                if (!IsOwnDatePickerClicked(evt, self[0])) {
                    if($(evt.target).hasClass('date-range-picker-startDate')){}
                    else if ($(evt.target).hasClass('date-range-picker-endDate')){}
                    else { if (box.is(':visible')) closeDatePicker(); }
                }
            });
        ...
        function dayClicked(day) {
            ...
            clearHovering();
            if (opt.start && !opt.end) {  // is first date clicked
                $(self).trigger('datepicker-first-date-selected', {
                    'date1': new Date(opt.start),
                    'day'  : day    // alanjsph@live.com
                });
                dayHovering(day);
            }
            ...
            $(self).trigger('datepicker-first-date-selected-after-default-clearings', { // alanjsph@live.com
                'date1': new Date(opt.start)
            });
        ...
        function autoclose() {
            if (opt.singleDate === true) {
                ...
                if (initiated && opt.start && opt.end) {
                    //if (opt.autoClose) closeDatePicker();  // alanjsph@live.com    the model wont auto close now,
                }                                                               //   but i have added the code to close the modal in the
